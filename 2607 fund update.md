...
The primary catalyst for underperformance were news reports circulating that nvidia kyber nvl144 would be delayed to 2028 production due to yield issues with the PCB midplane. This has implications for glass substrate players as the tech is expected to ramp at the same time CPO/NPO will. 

semianalysis has made it clear though then nvl144 is fully copper. so i suppose the idea is if we get slower roadmap for nvl144, then we wait longer for the next gen NVL576 feynman which should use cpo and npo and then glass substrates tracks that still. 

Trading advice that resonated with me in light of this month's underperformance
- you don't need to rush to buy the first dip. often it is more profitable to wait and see the second derivative change
- panic early, or double down late
- fight for your monthly p&l
